        ...
        <React.Fragment>
            <div className="form-row">
                ...
                <div className="form-group col-md-4 ml-5">
                    <NavLink className=" btn btn-info float-right" exact to='/home/CreateRol'>
                    ...
                    <tbody>
                        {
                            roles.map((rol, index) => (
                                <tr key={rol._id}>
                                    ...
                                    <td>{rol.name}</td>
                                    <td>{(rol.typeRol == 1)?'Edición':(rol.typeRol == 2)?'Visualización':(rol.typeRol == 3)?'Super admin':'Invitado'}</td>
